const CTA = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 relative">
      ...
      <div
        className="absolute -top-6 -left-4 bg-green-400 text-white px-8 py-3 rounded-full text-sm font-medium shadow-lg transform rotate-10 whitespace-nowrap"
        //   style="background: linear-gradient(135deg, #10b981 0%, #34d399 100%);"
      >
        ✨ Genera tu primera actualización gratis en menos de un minuto!
      </div>
      ...
      <div className="mt-6">
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="block w-full bg-gray-900 text-white py-3 px-6 rounded-lg font-semibold text-center hover:bg-gray-800 transition-colors mb-4 hover:cursor-pointer"
          >
        ...
        {/* Stats */}
        <div className="text-center text-sm text-gray-600 mb-4">⭐ 1.237 actualizaciones generadas este mes</div>
